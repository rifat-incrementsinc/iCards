                ...
                <div className="contact">
                    <Container>
                        <div className="" style={{padding: "10% 0%"}}>
                            <p className="contactTextBlock" style={{
                                fontSize: "40px",
                                width: "50%",
                                fontWeight: "700",
                                lineHeight: "49px",
                                ...
                                letterSpacing: "-2px",
                                textTransform: "capitalize"
                            }}>Get in touch with us if you're <span style={{color: "#11998E"}}>interested</span> in
                                learning more about our <span style={{color: "#2AB866"}}>services.</span></p>
                            <div className="contactDownDropBlock" style={{width: "50%"}}>
                                <div className="">
                                    <p style={{fontSize: "16px"}}>Subject</p>
                                    <input type='text' placeholder='Enter your Subject' style={{
                                        border: "none",
                                        backgroundColor: "transparent",
                                        outline: "none",
                                        borderBottom: "0.5px solid #DADBE0",
                                        paddingBottom: "8px",
                                        width: "100%"
                                    }}></input>
                                </div>
                                ...
                                <div className="">
                                    ...
                                    <input type='text' placeholder='A brief description here' style={{
                                        border: "none",
                                        backgroundColor: "transparent",
                                        outline: "none",
                                        borderBottom: "0.5px solid #DADBE0",
